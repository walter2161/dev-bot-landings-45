  ...
  const quickPrompts = [
    {
      ...
      prompt: "Imobiliária Prime - Corretor de Imóveis de alto padrão. Crie uma landing page elegante com seção hero apresentando os serviços, galeria com fotos de imóveis lindos, seção sobre o corretor e sua experiência, depoimentos de clientes satisfeitos, seção de diferenciais (atendimento personalizado, carteira exclusiva, negociação especializada), informações de contato e chat com IA para tirar dúvidas sobre imóveis. Cores: azul elegante e dourado. Transmita confiança e exclusividade."
    },
    {
      title: "Pizzaria",
      prompt: "Pizzaria Bella Massa - Pizzas artesanais e delivery. Crie uma landing page deliciosa com hero convidativo, seção mostrando as pizzas mais vendidas com fotos apetitosas, seção sobre a massa artesanal e ingredientes premium, galeria de fotos do ambiente e do forno a lenha, depoimentos de clientes, seção de promoções, informações de delivery e chat com IA para fazer pedidos e tirar dúvidas. Cores: vermelho, verde e dourado. Desperte o apetite!"
    },
    {
      title: "Materiais de Construção",
      prompt: "Constrular - Materiais de Construção e Acabamentos. Crie uma landing page profissional com hero destacando variedade e tradição, seção de categorias principais (cimento, tintas, pisos, ferragens), galeria de produtos, seção sobre a empresa e 20 anos de mercado, depoimentos de construtores parceiros, seção de diferenciais (entrega rápida, preços competitivos, atendimento técnico), informações de contato e chat com IA para orçamentos. Cores: laranja, cinza e azul industrial. Transmita solidez e confiança."
    },
    {
      title: "Oficina Mecânica",
      prompt: "Auto Mecânica Silva - Manutenção e Reparos Automotivos. Crie uma landing page moderna com hero apresentando os serviços, seção de serviços oferecidos (revisão, freios, suspensão, motor, elétrica), galeria mostrando a oficina e equipamentos modernos, seção sobre a equipe de mecânicos certificados, depoimentos de clientes, seção de diferenciais (garantia, peças originais, diagnóstico computadorizado), informações de contato e chat com IA para agendamento. Cores: preto, vermelho e prata. Transmita profissionalismo e cuidado."
    },
    {
      title: "Clínica Dentária",
      prompt: "Clínica Odonto Excellence - Odontologia Estética e Saúde Bucal. Crie uma landing page clean e profissional com hero acolhedor, seção de tratamentos oferecidos (clareamento, lentes, implantes, ortodontia), galeria de antes e depois, seção sobre os dentistas especialistas com fotos, depoimentos de pacientes, seção de diferenciais (tecnologia moderna, ambiente confortável, atendimento humanizado), informações de contato e chat com IA para agendamento. Cores: azul claro, branco e verde. Transmita confiança e cuidado."
    }
  ];
